 ...
 * @author danyc
 */
public class ConsuInventario extends javax.swing.JFrame {

    public static ConsuInventario obj;
    
    public static ConsuInventario getObj(){
        if(obj==null){
            obj=new ConsuInventario();
        }return obj;
    }
    
    
    public ConsuInventario() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsuInventario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsuInventario().setVisible(true);
            }
        });
    }
