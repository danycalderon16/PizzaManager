 ...
 * @author danyc
 */
public class IngresarEntradaSalida extends javax.swing.JFrame {

    public static IngresarEntradaSalida obj;
    
    public static IngresarEntradaSalida getObj(){
        if(obj==null){
            obj=new IngresarEntradaSalida();
        }return obj;
    }
    
    
    public IngresarEntradaSalida() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Ingresar Entrada / Salida");
        ...
        jLabel7.setText("USUARIOXX");

        jLabel11.setText("1:30 PM");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IngresarEntradaSalida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IngresarEntradaSalida().setVisible(true);
            }
        });
    }
